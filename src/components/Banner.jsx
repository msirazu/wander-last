...
const Banner = () => {
  return (
    <div style={{ backgroundImage: "url('https://wander-last.vercel.app/assets/images/banner.png')"}} className="bg-cover bg-center text-white flex flex-col items-center gap-6 md:h-150">
